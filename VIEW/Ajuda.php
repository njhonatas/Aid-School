...
<html lang="pt-br">
    <head>
        ...
        <!-- Passo a passo Css Link -->
        <link rel="stylesheet" href="../CSS/passoapasso.css">
    </head>
    <body>
        ...
        <section class="conteudo">
            ...
            <h2>Como doar? Siga o passo a passo</h2>
            <!-- FEATURES -->
            <section class="resume py-5 d-lg-flex justify-content-center align-items-center" id="resume">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="timeline">
                                <div class="timeline-wrapper">
                                    ...
                                    <div class="timeline-info">
                                        <h3><span>Realizar Cadastro</span></h3>
                                        <p>Após criar login e senha, selecione o perfil de doador e preencha as informações do usuário com cuidado e atenção.</p>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-wrapper">
                                    ...
                                    <div class="timeline-info">
                                        <h3><span>Escolher um Pedido</h3>
                                        <p>Após o cadastro, vá para a página de lista de pedidos e escolha uma instituição para fazer sua doação.</p>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-wrapper">
                                    ...
                                    <div class="timeline-info">
                                        <h3><span>Realizar Doações</h3>
                                        <p>Após selecionar um pedido de uma instituição, preencha as informações como quantidade e condição do item.</p>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-wrapper">
                                    ...
                                    <div class="timeline-info">
                                        <h3><span>Combinação do Método de Entrega</span></h3>
                                        <p>Você, como doador, só precisa entrar em contato com a instituição ou representante para combinar a entrega.</p>
                                    </div>
                                </div>
                        ...
                        <img src="../IMAGES/ilustra-home-1-71da0ee0b175eb6fcddf344038654ab0e86d66872703b5b5d83fcbe85ff68a9f.png" style="margin-left: 60px; height: 340px;">
                ...
                <div class="contatos">
                    <div class="content">
                        ...
                        <div class="right-side">
                            ...
                            <p></p>
                            <img src="../IMAGES/ilustracao-de-design-plano-de-suporte-ao-cliente_23-2148889374-removebg-preview.png" style=" height: 500px; margin-right: 100px;">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="help">
                ...
                <img src="../IMAGES/conceito-de-ilustracao-plana-de-atendimento-ao-cliente-em-fundo-branco_701961-2134.png" style="height: 290px; margin-left: 30px;">
