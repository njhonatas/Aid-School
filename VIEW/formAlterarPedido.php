...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="form-container">
            ...
            <!--formulario -->
            <form action="../CONTROLLER/AlterarPedido.php" method="post">

                <input type="hidden" name="idpedido" value="<?php echo $pedido["idpedido"] ?>">

                <div class="form-group">
                    <label for="nomepedido">Nome:</label>
                    <input type="text" name="nomepedido" required placeholder="Digite o nome do Pedido " value="<?php echo $pedido["nomepedido"] ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="quantidadepedido" required placeholder="Digite a Quantidade" min="1" value="<?php echo $pedido["quantidadepedido"] ?>">
                </div>
