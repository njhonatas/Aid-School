...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="form-container">
            <h2 class="form-title">Cadastro Doador</h2>
            ...
            <form name="CadastroDoador"  action="../CONTROLLER/CadastroDoadorController.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nomedoador" required placeholder="Digite seu Nome Completo">
                </div>

                <div class="form-group">
                    <label for="cpfdoador">CPF:</label>
                    <input type="text" name="cpfdoador" maxlength="14" required placeholder="Digite o seu CPF" oninput="formatarCPF(this)">
                </div>
            ...
            function formatarCPF(input) {
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="rgdoador" maxlength="9" required placeholder="Digite o seu RG" oninput="formatarRG(this)">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="telefonedoador" maxlength="13" required placeholder="Digite seu Número de Celular ex: 61-00000-0000" oninput="formatarTelefone(this)">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="emaildoador" required placeholder="Digite seu Endereço de Email " onblur="validacaoEmail(f1.email)"  maxlength="52" size='52'>
                    <div id="msgemail"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="enderecodoador" required placeholder="Digite seu Endereço ">
                </div>

                <div class="form-group">
                    <label for="dtnascdoador">Data de Nascimento:</label>
                    <input type="date" name="dtnascdoador" required>
                </div>
